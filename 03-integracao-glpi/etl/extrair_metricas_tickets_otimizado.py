        ...
        try:
            ...
            if 'Status' in self.df.columns:
                ...
                if sucesso:
                    ...
                    print(f"[ERRO] Falha ao salvar status")
            ...
            if 'Entidade' in self.df.columns:
                ...
                if sucesso:
                    ...
                    print(f"[ERRO] Falha ao salvar entidades")
            ...
            if 'Técnico' in self.df.columns:
                ...
                if sucesso:
                    ...
                    print(f"[ERRO] Falha ao salvar técnicos")
            ...
            if 'Grupo' in self.df.columns and 'Tempo Solução (min)' in self.df.columns:
                ...
                if len(df_ttr) > 0:
                    ...
                    if sucesso:
                        ...
                        print(f"[ERRO] Falha ao salvar TTR por grupo")
            ...
            if sucesso:
                ...
                print(f"[ERRO] Falha ao salvar relatório de qualidade")
