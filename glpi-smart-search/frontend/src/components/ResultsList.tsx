...
export default function ResultsList({ rows, total, pageSize, sort, setSort, page, setPage, query }: { rows: any[], total: number, pageSize: number, sort: string, setSort: (v: string) => void, page: number, setPage: (n: number) => void, query?: string }) {
