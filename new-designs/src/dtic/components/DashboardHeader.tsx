import { Calendar, RefreshCw, Activity, ArrowRightLeft, Search } from "lucide-react";
...
export function DashboardHeader({ onSwitchToDashboard, onSwitchToSearch }: DashboardHeaderProps) {
  const [startDate] = useState("21/10/2025");
  const [endDate] = useState("20/11/2025");
      ...
      <div className="px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <span className="text-sm">SIS</span>
          </button>
